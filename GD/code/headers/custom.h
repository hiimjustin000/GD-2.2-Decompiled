...
namespace Globals
{
    ...
    static cocos2d::CCPoint *gScollLayerPos = { 0.0f , 0.0f };
    static cocos2d::ccColor3B gNormalBarCol = { 0x00, 0xFF, 0x00 };
    static cocos2d::ccColor3B gPracticeBarCol = { 0x00, 0xFF, 0xFF };
