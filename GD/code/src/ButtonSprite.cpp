...
// 	m_obTextPosition = cocos2d::CCPoint(0.0f, 2.0f);
// 	if (_font != "bigFont.fnt") m_obTextPosition = cocos2d::CCPoint(-1.0f, 2.0f);
...
// 		if (rect.size.height >= m_pCustomTexture->getContentSize().height)
...
// 		if (Parent)
// 		{
// 			if (reinterpret_cast<CCMenuItemSpriteExtra*>(Parent))
// 			{
// 				Parent = getParent();
